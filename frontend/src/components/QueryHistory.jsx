    ...
    <div className="glass-card p-5">
      ...
      <div className="space-y-3 max-h-[380px] overflow-y-auto pr-1">
        {[...history].reverse().map((item, i) => (
          <div
            key={item.id}
            className="group relative bg-darkCard hover:bg-darkCard/90 border border-borderSubtle hover:border-accentPrimary/35 rounded-lg p-3.5 transition-all duration-150 cursor-pointer shadow-sm"
